...
protected:
    ...
    void prepare(programming_submission &prog, const path &source) {
        prog.category = "mock";
        prog.prob_id = "1234";
        prog.sub_id = "12340";
        ...
        submission->source_files.push_back(make_unique<local_asset>("test.cpp", source / "test.cpp"));
        submission->source_files.push_back(make_unique<local_asset>("adder.cpp", source / "adder.cpp"));
        submission->assist_files.push_back(make_unique<local_asset>("adder.hpp", source / "adder.hpp"));
...
TEST_F(GTestCheckerTest, AbnormalTest) {
    ...
    prepare(prog, code_files / "abnormal");
...
TEST_F(GTestCheckerTest, FailureTest) {
    ...
    programming_submission prog;
    prog.judge_server = &mock_judge_server;
    prepare(prog, code_files / "failure");
    programming_judger judger;
