...
protected:
    ...
    void prepare(programming_submission &prog, const string &language, const string &filename, const string &source) {
        prog.category = "mock";
        prog.prob_id = "1234";
        prog.sub_id = "12340";
        ...
        submission->source_files.push_back(make_unique<text_asset>(filename, source));
    ...
    void test(const string &lang, const string &filename, const string &source) {
        ...
        prepare(prog, lang, filename, source);
